...
| U-5 | 위치 패턴 학습 기준 (몇 회 이상 반복 시 패턴으로 인정할지) | 02_USER_EXPERIENCE.md |
...
| R-7 | 위치 기반 행동 패턴 학습 알고리즘 구현 방식 | 03_RECOMMENDATION.md |
...
| 2026-04-23 | Epic 1 사먹기 추천 구조 개편 (메뉴/식당 2단계 분리, 아코디언, 네이버 지도 딥링크) | Claude |
| 2026-05-18 | 위치 기반 지역 선택 UX 추가, 시간대별 메뉴 필터링 추가, 미확정 항목 U-5/R-7 신규 등록 | Claude |
